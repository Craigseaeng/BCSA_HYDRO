...
! Write formats 
298 FORMAT(F13.9,15F9.3)
299 FORMAT(F13.9,12F10.3)
300 FORMAT(F13.9,10F9.3)
301 FORMAT(F13.9,2X,I1,5F12.3)
302 FORMAT(F13.9,5F9.3)
303 FORMAT(F13.9,12F15.3)
304 FORMAT(F13.9,5F8.3)
