...
! Write formats 
298 FORMAT(E9.5,15F9.3)
299 FORMAT(E9.5,12F10.3)
300 FORMAT(E9.5,10F9.3)
301 FORMAT(E9.5,2X,I1,5F12.3)
302 FORMAT(E9.5,5F9.3)
303 FORMAT(E9.5,12F15.3)
304 FORMAT(E9.5,5F8.3)
