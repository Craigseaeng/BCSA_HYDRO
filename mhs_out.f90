...
! Write formats 
298 FORMAT(F10.6,15F9.3)
299 FORMAT(F10.6,12F10.3)
300 FORMAT(F10.6,10F9.3)
301 FORMAT(F10.6,2X,I1,5F12.3)
302 FORMAT(F10.6,5F9.3)
303 FORMAT(F10.6,12F15.3)
304 FORMAT(F10.6,5F8.3)
