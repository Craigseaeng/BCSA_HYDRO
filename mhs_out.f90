...
! Write formats 
298 FORMAT(F8.4,15F9.3)
299 FORMAT(F8.4,12F10.3)
300 FORMAT(F8.4,10F9.3)
301 FORMAT(F8.4,2X,I1,5F12.3)
302 FORMAT(F8.4,5F9.3)
303 FORMAT(F8.4,12F15.3)
304 FORMAT(F8.4,5F8.3)
